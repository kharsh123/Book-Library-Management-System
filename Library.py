...
class maincode:
     ...
     def cur(self):
             ...
             self.develop=Label(self.fm3,text='Developed By - Harshad Kamble, Mangesh Deshpande, Aman Wankar, Umesh Padwal',bg='#fff',fg='blue',
                               font=('Cursive',12,'italic','bold'))
             self.develop.place(x=100,y=350)
